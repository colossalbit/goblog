...
GOBLOG_ARTICLE_COMPILER_DEFAULT = getattr(settings, 'GOBLOG_ARTICLE_COMPILERS', None)
...
ARTICLE_COMPILER_CHOICES = ((k,k) for k in sorted(GOBLOG_ARTICLE_COMPILERS.keys()))
