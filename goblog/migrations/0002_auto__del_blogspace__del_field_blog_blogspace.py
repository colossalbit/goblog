...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Blog.blogspace'
        db.delete_column('goblog_blog', 'blogspace_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Blog.blogspace'
        raise RuntimeError("Cannot reverse this migration. 'Blog.blogspace' and its values cannot be restored.")
    models = {
        'auth.group': {
