...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArticleContent.id'
        db.delete_column('goblog_articlecontent', 'id')


        # Changing field 'ArticleContent.article'
        db.alter_column('goblog_articlecontent', 'article_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['goblog.Article']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ArticleContent.id'
        raise RuntimeError("Cannot reverse this migration. 'ArticleContent.id' and its values cannot be restored.")

        # Changing field 'ArticleContent.article'
        db.alter_column('goblog_articlecontent', 'article_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['goblog.Article']))
